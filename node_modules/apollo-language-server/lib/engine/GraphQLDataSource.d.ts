...
export declare class GraphQLDataSource<TContext = any> {
    ...
    mutation(mutation: DocumentNode, options: GraphQLRequest): Promise<import("apollo-link/lib/types").FetchResult<{
        [key: string]: any;
    }, Record<string, any>, Record<string, any>> | undefined>;
    query(query: DocumentNode, options: GraphQLRequest): Promise<import("apollo-link/lib/types").FetchResult<{
        [key: string]: any;
    }, Record<string, any>, Record<string, any>> | undefined>;
